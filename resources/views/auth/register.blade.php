                ...
                <div class="card-body">
                    <form id="registration-form"  method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <div class="col-md-6 offset-md-4 mb-3">
                                <div class="radio">
                                    <label><input type="radio" name="product" value="MEI" checked>MEI  R$ 50,00/Mês</label>
                                </div>
                                <div class="radio">
                                    <label><input type="radio" name="product" value="PME">PME  R$100,00/Mês</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit"  id="card-button" onclick="e.preventDefault();"  class="btn btn-primary" data-secret="{{ $intent->client_secret }}">
                                    {{ __('Register') }}
                                </button>
                            </div>
                        </div>
